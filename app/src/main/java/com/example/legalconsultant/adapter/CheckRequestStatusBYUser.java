...
public class CheckRequestStatusBYUser extends BaseAdapter {
    List<Request> requestList;
    Context context;
    int check;
    LayoutInflater inflater;
    public CheckRequestStatusBYUser(List<Request> requestList, Context context, int check) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, UserRequestDetailActivity.class)
                        ...
                        .putExtra("FK_LAWYER_ID", requestList.get(position).getFk_lawyer_id())
