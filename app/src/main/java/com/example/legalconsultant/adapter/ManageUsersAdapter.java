...
public class ManageUsersAdapter extends BaseAdapter {
    ...
    public ManageUsersAdapter(List<User> usersList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.tv_user, parent, false);
        TextView tv_user, tv_mail, tv_cntct, tv_cnic;
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, ManageUserProfile.class)
